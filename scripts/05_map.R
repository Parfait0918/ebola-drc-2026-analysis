...
province_data <- data.frame(province = c("Ituri", "North Kivu", "South Kivu", "Kampala (Uganda)"),
...
pal <- colorNumeric(palette = c("yellow", "orange", "red", "darkred"), domain = province_data$cases)
...
map <- leaflet(province_data) |>
    ...
    addLegend(position = "bottomright", 
        ...
        opacity = 0.8)|>
    addControl("<b>Ebola Bundibugyo Outbreak — DRC & Uganda 2026</b><br> Source: ECDC & WHO | Click circles for details", 
        position = "topright")
